...
/**
An alternative endpoint made with standard REST controller. Get input params are converted to Point and Distance in order to be used in MongoDB geospatial query.
**/
@RestController
